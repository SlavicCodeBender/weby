...
const en: Dict = {
  ...
  gallery: {
    ...
    items: [
      { title: 'Apartment, Krk', meta: 'Terrace · 2025.', image:'/ApartmanKrk.jpg' },
      { title: 'Family House, Rijeka', meta: 'Double-Sash Window · 2024.', image:'/DvokrilniProzorRijeka.jpg' },
      { title: 'Holiday Home, Fužine', meta: 'Canopy · 2026.', image:'/NatsresnicaFuzine.jpg' },
      { title: 'Family House, Krk', meta: 'Canopy · 2025.', image:'/NatsresnicaKrk.jpg' },
      { title: 'Awaiting Installation', meta: 'Tilt-and-Turn Window · 2026.', image:'/OtklopniZatvorniProzor.jpg' },
      { title: 'Apartment, Istria', meta: 'Pleated Insect Screens · 2026.', image:'/PliseKomarnici.jpg' },
   ],
  },
  contact: {
